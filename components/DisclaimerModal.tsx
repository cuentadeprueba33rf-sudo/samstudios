...
export const DisclaimerModal: React.FC<DisclaimerModalProps> = ({ onAccept }) => {
  return (
    <div className="fixed inset-0 z-[200] bg-black flex items-center justify-center p-4 animate-fade-in">
      ...
      <div className="relative bg-[#0f1014] border border-white/10 rounded-2xl max-w-2xl w-full shadow-2xl overflow-hidden">
        {/* Header decoration */}
        <div className="h-1 w-full bg-gradient-to-r from-transparent via-[#E50914] to-transparent" />
        
        <div className="p-8 md:p-10">
          <div className="flex flex-col items-center text-center mb-8">
            <h1 className="text-3xl font-black text-[#E50914] tracking-tighter mb-2">SAMSTUDIOS</h1>
            <h2 className="text-xl font-semibold text-white">Política de Transparencia</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-white/10 transition-colors">
              <div className="bg-gray-800 p-2.5 rounded-lg shrink-0">
                <ServerOff className="h-6 w-6 text-blue-400" />
              </div>
              <div>
                <h3 className="text-white font-bold text-base">Sin Servidores Propios</h3>
            ...
            <div className="flex items-start gap-4 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-white/10 transition-colors">
              ...
              <div>
                <h3 className="text-white font-bold text-base">Enlaces Externos</h3>
                <p className="text-gray-400 text-xs md:text-sm mt-1 leading-relaxed">
                  Todo el contenido proviene de servidores públicos de terceros. Nosotros facilitamos el acceso organizando estos enlaces en una interfaz limpia.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-4 rounded-xl bg-white/5 border border-white/5 hover:border-white/10 transition-colors">
              ...
              <div>
                <h3 className="text-white font-bold text-base">Tu Seguridad es Primero</h3>
                <p className="text-gray-400 text-xs md:text-sm mt-1 leading-relaxed">
                  Nuestro objetivo es evitar que navegues por sitios inseguros llenos de spam, virus o publicidad intrusiva. Filtramos lo mejor para ti.
                </p>
              </div>
            </div>
